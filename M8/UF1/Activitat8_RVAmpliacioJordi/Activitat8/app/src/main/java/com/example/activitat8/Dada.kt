...
fun omplirDades(){
    dades.addAll(
        listOf(
            Dada(0, snow_rain, 3, 6, 80, 11,1),
            Dada(1, snow, 3, 4, 80, 10,1),
            Dada(2, snow_sunny, 3, 1, 75, 9,2),
            Dada(3, cloudy, 2, 0, 75, 5,1),
            Dada(4, cloudy, 2, 0, 75, 5,1),
            Dada(5, partly_cloudy, 3, 0, 70, 3,2),
            Dada(6, partly_cloudy, 4, 0, 65, 3,2),
            Dada(7, sunny_rain, 4, 0, 70, 5,1)
        )
    )
}
