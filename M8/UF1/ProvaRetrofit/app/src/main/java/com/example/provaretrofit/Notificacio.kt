...
class Notificacio(val context: Context) {
 ...
 /*   fun mostraNotificacio1(notificacio: Notification){
    ...
    fun generaNoticacioText(titol: String, contingut: String, textllarg: String, requestCode : Int) {
        ...
        val notifyIntent = Intent(context, nav_home_good::class.java).apply {
            flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK
        }

        val notifyPendingIntent = PendingIntent.getActivity(
            context, requestCode, notifyIntent,
