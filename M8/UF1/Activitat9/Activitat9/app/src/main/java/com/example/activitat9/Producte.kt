...
public lateinit var listPortada: java.util.ArrayList<Portada>
public lateinit var listProducte: java.util.ArrayList<Producte>
public lateinit var listCarrito: java.util.ArrayList<ProducteCarret>
...
fun omplirProductes(){
    ...
    /*for (i in 0..listProducte.size - 1){
        if(tipusPro == listProducte[i].tipusProducte){
            listProducte.add(listProducte[i])
        }
    }*/
