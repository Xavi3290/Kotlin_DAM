...
class nav_ordinadors : Fragment() {
    ...
    override fun onCreateView(
        ...
        if(userBD!![0].tipus == 0){
            notificacio.generaNoticacioText("Especial", "Lenovo IdeaPad 1 15ADA7", "Lenovo IdeaPad 1 15ADA7, 15.6\" Full HD, AMD Ryzen™ 5 3500U, 8GB RAM, 512GB SSD, Radeon™ Vega 8 Graphics, Windows 11 Home")
            notificacio.generaNoticacioText("Especial", "Lenovo IdeaPad 1 15ADA7", "Lenovo IdeaPad 1 15ADA7, 15.6\" Full HD, AMD Ryzen™ 5 3500U, 8GB RAM, 512GB SSD, Radeon™ Vega 8 Graphics, Windows 11 Home")
        }
