...
import com.example.activitat9bona.databinding.FragmentNavSmartphonesBinding
...
class nav_smartphones : Fragment() {
    ...
    override fun onCreateView(
        ...
        if(userBD!![0].tipus == 0){
            notificacio.generaNoticacioText("Especial", "Samsung Galaxy S22 Ultra 5G", "TV OLED 65\" - LG OLED65CS6LA, UHD 4K, α9 Gen5 AI Processor 4K, Smart TV, DVB-T2 (H.265), Plata")
            notificacio.generaNoticacioText("Especial", "Samsung Galaxy S22 Ultra 5G", "Samsung Galaxy S22 Ultra 5G, Black, 256GB, 12GB RAM, 6.8\" QHD+, Exynos 2200, 5000mAh, Android 12")
        }
