...
data class AdaptadorProducteJson(var llista: java.util.ArrayList<Producte_JsonItem>) :
    RecyclerView.Adapter<AdaptadorProducteJson.viewholder>() {
    ...
    fun updateDades(novallista: java.util.ArrayList<Producte_JsonItem>) {
        llista = novallista
