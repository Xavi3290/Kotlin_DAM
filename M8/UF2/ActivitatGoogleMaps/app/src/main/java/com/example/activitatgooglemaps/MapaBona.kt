...
import com.example.activitatgooglemaps.databinding.ActivityMapaBonaBinding
...
class MapaBona : AppCompatActivity(), OnMapReadyCallback, CoroutineScope {

    private lateinit var binding: ActivityMapaBonaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMapaBonaBinding.inflate(layoutInflater)
        //binding = ActivityMapaBonaBinding.inflate(layoutInflater)
        ...
        val mapFragment = supportFragmentManager
            .findFragmentById(R.id.mapBo) as SupportMapFragment
