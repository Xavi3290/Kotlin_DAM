...
import com.example.activitatcamerax.databinding.ActivityCamaraBinding
import java.io.File
   ...
   private lateinit var broadcastManager: LocalBroadcastManager
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            if(binding.videoSwitch.isChecked == false ){
                // CameraProvider
            ...
            outputOptions, ContextCompat.getMainExecutor(this), object : ImageCapture.OnImageSavedCallback {
                ...
                override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        ...
                        binding.photoViewButton.setImageURI(savedUri)
                        binding.photoViewButton.setOnClickListener {
                            val intent = Intent(applicationContext, FotoGallery::class.java)
                            intent.putExtra("urlfoto", savedUri.toString())
    ...
    private fun captureVideo() {
        ...
        val curRecording = recording  //videoCapture no se
