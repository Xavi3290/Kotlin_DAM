...
import com.example.provaexamen.BD.Emisora
import com.example.provaexamen.databinding.CardviewsoBinding
...
class AdaptadorEmissora (var llista: java.util.ArrayList<Emisora>, var mMediaPlayer: MediaPlayer?) :
    ...
    class viewholder(val view: View) : RecyclerView.ViewHolder(view) {
        val binding = CardviewsoBinding.bind(view)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewholder {
        val layout = LayoutInflater.from(parent.context)
        return viewholder(layout.inflate(R.layout.cardviewso, parent, false))
    }
