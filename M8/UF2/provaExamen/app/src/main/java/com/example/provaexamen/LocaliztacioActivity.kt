...
import com.example.provaexamen.databinding.ActivityLocaliztacioBinding
import com.google.android.gms.location.FusedLocationProviderClient
import com.google.android.gms.location.LocationServices
import kotlinx.coroutines.*
import kotlin.coroutines.CoroutineContext

class LocaliztacioActivity : AppCompatActivity(), CoroutineScope {

    private lateinit var binding:ActivityLocaliztacioBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLocaliztacioBinding.inflate(layoutInflater)
        ...
        binding.bSegonaActivity.setOnClickListener {
            val intent = Intent(this,LlistaUbicacioActivity::class.java)
                        ...
                        .addOnSuccessListener { location: Location? ->
                            runBlocking {
                                val corrutina = launch {
                                    ...
                                    db.daoubicacions().afegeixUbicacio(ubi)
                                    Toast.makeText(
